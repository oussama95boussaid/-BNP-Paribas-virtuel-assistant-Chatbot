...
# %%
# Install required packages - HuggingFace Embeddings + OpenAI
# !pip install langchain==0.3.17 langchain-community==0.3.16 langchain-core==0.3.28 langchain-openai==0.2.14 chromadb==0.5.23 sentence-transformers==3.3.1 langchain-huggingface==0.1.2 python-dotenv
...
if not os.getenv("OPENAI_API_KEY"):
    ...
    print("Option 1: os.environ['OPENAI_API_KEY'] = 'your-key'")
...
print("Configuration:")
print(f"  Embedding Model: {EMBEDDING_MODEL} (FREE)")
print(f"  LLM Model: {LLM_MODEL} (OpenAI)")
